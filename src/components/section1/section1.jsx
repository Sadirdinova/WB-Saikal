            ...
            <div className='section1-item'>
                ...
                <div className='section1-img'>
                    ...
                    <div className='section1-image'>
                        <a href="tel:+996507092973"><img src={phone} alt="" /></a>
                        <a href="https://api.whatsapp.com/send?phone=996507092973"><img src={wa} alt="" /></a>
                        <a href="https://www.instagram.com/medina01.01.01/"><img src={instagram} alt="" /></a>
                    </div>
                </div>
            </div>
